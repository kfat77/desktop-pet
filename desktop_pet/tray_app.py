...
class TrayApp(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._tray.setToolTip("桌面宠物 \U0001F431 - 左右键拖动召唤小猫")
        
        # 创建菜单
        self._menu = QMenu()
        
        # 添加菜单项
        self._show_info = self._menu.addAction("\U0001F431 桌面宠物已运行")
        ...
        self._exit_action = self._menu.addAction("\U0001F6AA 退出")
